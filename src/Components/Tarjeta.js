...
import clima1 from '../assets/img/clima1.jpg'
import tarjeta from '../assets/css/tarjeta.css'

const Tarjeta = ({loadingData, showDate, weather, forecast}) => {
                    ...
                    <div className='card  mb-3 mx-auto text-light'>
                        <div className='row g-0'>
                            <div className='col-md-6'>
                                ...
                                <p className='card-desc'><img src={iconUrl} className='img-clim' alt="icon"/>{weather.weather[0].description}</p>
                                <img className='img-clima' src={clima1} />
                            </div>
                            <div className='col-md-6 dos'>
                                <div className='card-body text-start mt-2'>
                                    ...
                                    <h5 className='card-text'>Velocidad del tiempo: {(weather.wind.speed)}m/s</h5>
                                </div>
                                <hr/>
                                ...
                                <div className='row mt-4'>
                                    <div className='col'>
                                        ...
                                        <p className='description'>
                                            <img className='img-pronostico' src={iconUrl3} alt='icon'/>{forecast.list[1].weather[0].description}
                                        </p>
                                    ...
                                    <div className='col'>
                                        <p>{forecastDate6}h</p>
                                        <p className='description'>
                                            <img className='img-pronostico' src={iconUrl6} alt='icon'/>{forecast.list[2].weather[0].description}
                                        </p>
                                    ...
                                    <div className='col'>
                                        <p>{forecastDate9}h</p>
                                        <p className='description'>
                                            <img className='img-pronostico' src={iconUrl9} alt='icon'/>{forecast.list[3].weather[0].description}
                                        </p>
